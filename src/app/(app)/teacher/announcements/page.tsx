...
import { createTeacherAnnouncementAction } from "@/server/actions/teacher-self.actions";
...
export default async function TeacherAnnouncementsPage() {
  ...
  return (
    <div>
      <PageHeader title="ประกาศ" description="ครูทุกคนสามารถประกาศข่าวสารถึงครูและนักเรียนได้" />

      <div className="grid gap-6 lg:grid-cols-5">
        <div className="lg:col-span-2">
          <AnnouncementComposer action={createTeacherAnnouncementAction} />
        </div>
